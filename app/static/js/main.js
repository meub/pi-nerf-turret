  ...
  *****************************************/
  $(document).ready(function(){
    ...
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
        ...
        // Joystick
        var joystick = new Joystick("joystick-section", 0, {}, "right");
    ...
    // Desktop
        ...
        function updateCamera(camera) {
            ...
            var new_values = convertRatio( camera.x, camera.y, 0, 300, 0, canvas_size);
            ...
            socket_control.emit('control', {data:{"right":coords}});
        }
